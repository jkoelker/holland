"""
This is the ExampleController for the holland.cli application.  This can be used
...
from holland.cli.model.example import ExampleModel
...
class ExampleController(CementController):
    ...
    def ex1(self):
        ...
        # So if you have added cli options in your holland.cli.bootstrap.example
    ...
    def ex1_help(self):
        ...
        executed when you run:
            ...
            $ holland.cli example ex1-help
        
        """
        print "This is the help method for ex1."
    
    @expose('holland.cli.templates.example.ex2', namespace='example')    
    def ex2(self): 
        """
        ...
        # holland.cli/bootstrap/example.py:
    ...
    def cmd2(self):
        ...
        foo = "In holland.cli.controllers.example.cmd2()"
        print foo
        return dict(foo=foo)